...
<script type="text/javascript">
	$(function(){
		...
		$("#pagecode").click(function(){
			$("#pagecode").attr("src","/user?action=validate&c="+Math.random());
		});
		//3.验证输入的验证码 是否正确
...
<body>
		...
		<form  method="post" action="/user" class="form center" id="userLogin" >
		<div class="login">
			...
			<div class="login_center">
				...
				<div class="login_main center">
					...
					<div class="username">
						...
						<img  id="pagecode" src="/user?action=validate"><label id="checkMsg"></label></div>
					</div>
					<div class="username">
					...
					<div class="login_submit">
						<input class="submit" type="submit" name="submit" value="立即登录" id="btn" disabled="disabled" >
					</div>
