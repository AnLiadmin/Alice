...
<script type="text/javascript">
	...
	function defaultAddr(id){
		...
		if(res==true){
			window.location.href="http://localhost:8080/addr?action=updateDefault&aid="+id;
    ...
    <div id="dingdanxiangqing_body_big">
     ...
     <div id="big_right" style="height: 500px;overflow: scroll;">
							...
							<div class="modal fade" tabindex="-1" role="dialog" id="myModal${address.a_id}">
							  <div class="modal-dialog" role="document">
							    <div class="modal-content">
									...
									<form action="addr?action=update" method="post" class="form-horizontal">
		...
		<div class="container" style="width:960px;">
			...
			<form action="addr?action=addAddress" method="post" class="form-horizontal">
				<div class="form-group">
