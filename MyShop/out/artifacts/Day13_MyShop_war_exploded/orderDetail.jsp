		...
		<tr>
			<td align="right" colspan="4" style="margin-right: 40px;">
				...
				<c:if test="${od.o_state eq 1 }">
					<button type="button" onclick="pay('${od.o_id}','${od.o_count}')" class="btn btn-warning btn-sm">易付宝支付</button>
						&nbsp;&nbsp;
					<button type="button" onclick="payWeiXin('${od.o_id}','${od.o_count}')" class="btn btn-success btn-sm">微信支付</button>
				</c:if>
			</td>
		</tr>
	</table>
